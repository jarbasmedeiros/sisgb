...
@section('content')
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong>ATUALIZAÇÃO DE INFORMAÇÕES DA UNIDADE - {{$unidade->st_sigla}}</strong></div>
                    <div class="panel-body">
                        @can('Administrador')                        
                            <form role="form" method="POST" name="form" action="{{url('/admin/unidades/edit/'.$unidade->id)}}">
                                {{ csrf_field() }}                               
                                    ...
                                    <legend class="scheduler-border">Informações Gerais</legend>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group{{ $errors->has('st_sigla') ? ' has-error' : '' }} col-md-4">
                                                ...
                                                <input id="st_sigla" type="text" class="form-control"  placeholder="Não informado" name="st_sigla" value="{{$unidade->st_sigla}}" required> 
                                        ...
                                        <div class="row">
                                            <div class="form-group{{ $errors->has('st_descricao') ? ' has-error' : '' }} col-md-7">
                                                ...
                                                <input id="st_descricao" type="text" class="form-control"  placeholder="Não informado" name="st_descricao" value="{{$unidade->st_descricao}}" required> 
                                            ...
                                            @if($estado=='MANUTENCAO')
                                                <div class="form-group{{ $errors->has('bo_organogramanovo') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class='form-control'  name='bo_organogramanovo' id='bo_organogramanovo'>
                                                ...
                                                <div class="form-group{{ $errors->has('bo_corrigido') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class='form-control'  name='bo_corrigido' id='bo_corrigido'>
                                                        <option value=""> -- Selecionar -- </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group{{ $errors->has('bo_organograma') ? ' has-error' : '' }} col-md-4">
                                                ...
                                                <select class='form-control'  name='bo_organograma' id='bo_organograma' required>
                                                <option value=""> -- Selecionar -- </option>
                                            ...
                                            <div class="form-group hidden{{ $errors->has('st_arvore') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-10">
                                                    <input class='form-control' type='text' name='st_arvore' id='st_arvore' disabled value="{{$unidade->st_tipo}}">                                    
                                ...
                                <fieldset  class="scheduler-border">
                                    ...
                                    <div class="row">
                                        <div class="form-group{{ $errors->has('st_comandante') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            <input id="st_comandante" type="text" class="form-control" placeholder="Não informado" name="st_comandante" value="{{$unidade->st_comandante}}"  > 
                                        ...
                                        <div class="form-group{{ $errors->has('st_sigla') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            <input id="st_subcomandante" type="text" class="form-control"  placeholder="Não informado" name="st_subcomandante" value="{{$unidade->st_subcomandante}}" > 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('st_logradouro') ? ' has-error' : '' }} col-md-4">
                                            ...
                                            <input id="st_logradouro" type="text" class="form-control"  placeholder="Não informado" name="st_logradouro" value="{{$unidade->st_logradouro}}"  > 
                                         ...
                                         <div class="form-group{{ $errors->has('st_numero') ? ' has-error' : '' }} col-md-2">
                                            ...
                                            <input id="st_numero" type="text" class="form-control"  placeholder="Não informado" name="st_numero" value="{{$unidade->st_numero}}"  > 
                                        ...
                                        <div class="form-group{{ $errors->has('st_bairro') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            <input id="st_bairro" type="text" class="form-control"  placeholder="Não informado" name="st_bairro" value="{{$unidade->st_bairro}}"  > 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('st_complemento') ? ' has-error' : '' }} col-md-5">
                                            ...
                                            <input id="st_complemento" type="text" class="form-control"  placeholder="Não informado" name="st_complemento" value="{{$unidade->st_complemento}}"  > 
                                        ...
                                        <div class="form-group{{ $errors->has('st_cidade') ? ' has-error' : '' }} col-md-4">
                                            ...
                                            <input id="st_cidade" type="text" class="form-control"  placeholder="Não informado" name="st_cidade" value="{{$unidade->st_cidade}}" > 
                                         ...
                                         <div class="form-group{{ $errors->has('st_cep') ? ' has-error' : '' }} col-md-2">
                                            ...
                                            <input id="st_cep" type="text" class="form-control"  placeholder="Não informado" data-mask="00000-000" name="st_cep" value="{{$unidade->st_cep}}"  > 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('st_latitude') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            <input id="st_latitude" type="text" class="form-control"  placeholder="Não informado" name="st_latitude" value="{{$unidade->st_latitude}}" > 
                                        ...
                                        <div class="form-group{{ $errors->has('st_longitude') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            <input id="st_longitude" type="text" class="form-control"  placeholder="Não informado" name="st_longitude" value="{{$unidade->st_longitude}}" >
                                    ...
                                    <div class="row">
                                        <div class="form-group{{ $errors->has('st_site') ? ' has-error' : '' }} col-md-4">
                                            ...
                                            <input id="st_site" type="text" class="form-control"  placeholder="pm.rn.gov.br" name="st_site" value="{{$unidade->st_site}}" >
                                        ...
                                        <div class="form-group{{ $errors->has('st_email') ? ' has-error' : '' }} col-md-4">
                                            ...
                                            <input id="st_email" type="email" id="email" class="form-control" maxlength="50" placeholder="0000-0000" name="st_email" value="{{$unidade->st_email}}" >
                                        ...
                                        <div class="form-group{{ $errors->has('st_contato') ? ' has-error' : '' }} col-md-4">
                                            ...
                                            <input id="st_contato" type="text" class="form-control" data-mask="0000-0000" placeholder="0000-0000" name="st_contato" value="{{$unidade->st_contato}}" > 
                        ...
                        @can('Relatorios_rh')
                            <form role="form" method="POST" action="{{url('/admin/unidades/edit/'.$unidade->id)}}">
                                {{ csrf_field() }}                               
                                <fieldset  class="scheduler-border">
                                    <legend class="scheduler-border">Informações Adicionais</legend>       
                                    <div class="row">
                                        <div class="form-group{{ $errors->has('st_comandante') ? ' has-error' : '' }} col-md-6">
                                            <label for="st_comandante">Comandante da Unidade:</label>
                                            <input id="st_comandante" type="text" class="form-control" placeholder="Não informado" name="st_comandante" value="{{$unidade->st_comandante}}" required > 
                                            @if ($errors->has('st_comandante'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('st_comandante') }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group{{ $errors->has('st_sigla') ? ' has-error' : '' }} col-md-6">
                                            <label for="st_subcomandante">Sub Comandante da Unidade</label>
                                            <input id="st_subcomandante" type="text" class="form-control"  placeholder="Não informado" name="st_subcomandante" value="{{$unidade->st_subcomandante}}" > 
                                            @if ($errors->has('st_subcomandante'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('st_subcomandante') }}</strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('st_cidade') ? ' has-error' : '' }} col-md-4">
                                            <label for="st_cidade">Cidade</label>
                                            <input id="st_cidade" type="text" class="form-control"  placeholder="Não informado" name="st_cidade" value="{{$unidade->st_cidade}}" required> 
                                            @if ($errors->has('st_cidade'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('st_cidade') }}</strong>
                                            </span>
                                         ...
                                         <div class="form-group{{ $errors->has('st_cep') ? ' has-error' : '' }} col-md-3">
                                            <label for="st_cep">Cep</label>
                                            <input id="st_cep" type="text" class="form-control"  placeholder="Não informado" data-mask="00000-000" name="st_cep" value="{{$unidade->st_cep}}"  > 
                                            @if ($errors->has('st_cep'))
                                            <span class="help-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('st_email') ? ' has-error' : '' }} col-md-4">
                                            <label for="st_email" class="control-label">Email da Unidade</label>
                                            <input id="st_email" type="email" id="email" class="form-control" maxlength="50" placeholder="Não informado" name="st_email" value="{{$unidade->st_email}}" >
                                        ...
                                        <div class="form-group{{ $errors->has('st_contato') ? ' has-error' : '' }} col-md-4">
                                            <label for="st_contato">Contato da Unidade:</label>
                                            <input id="st_contato" type="text" class="form-control" data-mask="0000-0000" placeholder="0000-0000" name="st_contato" value="{{$unidade->st_contato}}" required > 
                                            @if ($errors->has('st_contato'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('st_contato') }}</strong>
                                            </span>
