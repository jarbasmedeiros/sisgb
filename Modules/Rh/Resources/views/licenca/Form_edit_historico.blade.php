            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('rh/historicolicenca/update/' . $idPolicial . '/' . $idLicenca . '/' . $historico->id) }}">
                            {{ csrf_field() }}
                            @if($historico->st_tipo == 'Licenca' || $historico->st_tipo == 'Licença')
                                <div class="form-group{{ $errors->has('nu_dias') ? ' has-error' : '' }}">
                                    <label for="nu_dias" class="col-md-2 control-label">Dias:</label>
                                    <div class="col-md-2">
                                        <input type="number" id="dias" name="nu_dias" class="form-control" required="true" onchange="datafim()" value="{{$historico->nu_dias}}">
                                ...
                                <div class="form-group{{ $errors->has('dt_inicio') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" id="inicio" name="dt_inicio" class="form-control" required="true" onchange="datafim()" value="{{$historico->dt_inicio}}">
                                ...
                                <div class="form-group{{ $errors->has('dt_fim') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" id="fim" name="dt_fim" class="form-control" required="true" readonly value="{{$historico->dt_fim}}">
                            ...
                            <div class="form-group{{ $errors->has('st_descricao') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <textarea id="descricao" name="st_descricao" rows="6" class="form-control">{{$historico->st_descricao}}</textarea>
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-2">
                                    <a href="{{url('rh/historicolicenca/lista/' . $idPolicial . '/' . $idLicenca)}}" class=" btn btn-warning" title="Voltar">
