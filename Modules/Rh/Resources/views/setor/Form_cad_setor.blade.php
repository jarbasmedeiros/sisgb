        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">Cadastro Setor</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/rh/setores') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('st_descricao') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" required="true" placeholder="Descrição" name="st_descricao" value="{{ old('st_descricao') }}"> 
