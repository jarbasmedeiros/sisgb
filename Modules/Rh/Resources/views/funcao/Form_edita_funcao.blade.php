        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">Editar Função</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action='{{ url("rh/funcao/edita/$funcao->id") }}'>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('st_funcao') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" required="true" placeholder="Função" name="st_funcao" value="{{$funcao->st_funcao}}"> 
