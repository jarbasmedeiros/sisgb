...
@section('title', 'Cadastro de Status de Função')
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">Cadastro Status de Função</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/rh/statusfuncoes') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('st_status') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="status" type="text" class="form-control" required="true" placeholder="Status de Função" name="st_status" value="{{ old('st_status') }}"> 
