...
<body>
    ...
    $mpdf->SetTitle("Declaração Anual de Beneficiários");//titulo da pagina
    ...
    $dados_pdf .= "
                ...
                <div class='mt-20'>
                    ...
                    <div class='tituloextrato'>
                        DECLARAÇÃO ANUAL DE BENEFICIÁRIOS DE ".$dadosCertidao->st_ano."
                    </div>
                ";
    ...
    if($dadosCertidao->dt_assinaturapolicial && $dadosCertidao->dt_assinaturaresponsavel){
        ...
        <div class='conteudot5' >
            ...
            <h5>Assinado eletronicamente no dia <strong>".date("d/m/Y",strtotime($dadosCertidao->dt_assinaturapolicial))."</strong> às <strong>".date("H:i:s",strtotime($dadosCertidao->dt_assinaturapolicial))."h</strong>.</h5>
        </div>";
        ...
        <div class='conteudot5'>
            ...
            <h5>Assinado eletronicamente no dia <strong>".date("d/m/Y",strtotime($dadosCertidao->dt_assinaturaresponsavel))."</strong> às <strong>".date("H:i:s",strtotime($dadosCertidao->dt_assinaturaresponsavel))."h</strong>.</h5>
        </div>";
    } else {
