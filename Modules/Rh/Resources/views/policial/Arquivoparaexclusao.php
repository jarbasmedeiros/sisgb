...
<div class="tab-pane active" id="publicacoes">
    <h4 class="tab-title">Movimentação - {{ strtoupper($policial->st_nome) }}</h4>
    <hr class="separador">
            ...
            <fieldset class="scheduler-border">    	
                ...
                <div class="form-group{{ $errors->has('ce_unidadedestino') ? ' has-error' : '' }}" class="col-md-12">
                    ...
                    <div class="form-group{{ $errors->has('dt_movimentacao') ? ' has-error' : '' }} col-md-3">
                        ...
                        <input id="dt_movimentacao" type="date" class="form-control" name="dt_movimentacao"> 
                    ...
                    <div class="form-group{{ $errors->has('st_publicacao') ? ' has-error' : '' }} col-md-3">
                        ...
                        <input id="st_publicacao" type="text" class="form-control" placeholder="Boletim de Publicação" name="st_publicacao"> 
                    ...
                    <div class="form-group{{ $errors->has('dt_publicacao') ? ' has-error' : '' }} col-md-3">
                        ...
                        <input id="dt_publicacao" type="date" class="form-control" name="dt_publicacao"> 
