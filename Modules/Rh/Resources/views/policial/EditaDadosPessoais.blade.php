...
<div class="tab-pane active" id="dados_pessoais">
    ...
    <hr class="separador">
    <form role="form" method="POST" action="{{ url('/rh/policiais/edita/'.$policial->id.'/dados_pessoais') }}">
        {{ csrf_field() }}
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_nome') ? ' has-error' : '' }} col-md-4">
                    ...
                    <input id="st_nome" type="text" class="form-control" placeholder="Digite o nome" name="st_nome" value="{{ $policial->st_nome }}" required> 
                ...
                <div class="form-group{{ $errors->has('dt_nascimento') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="dt_nascimento" type="date" class="form-control" name="dt_nascimento" value="{{ $policial->dt_nascimento }}" required> 
                ...
                <div class="form-group{{ $errors->has('st_sexo') ? ' has-error' : '' }} col-md-1">
                    ...
                    <div class="radio">
                        <label class="radio-option">
                            <input type="radio" name="st_sexo" id="st_sexo" value="MASCULINO" {{ ($policial->st_sexo == 'MASCULINO') ? 'checked':'' }} required>
                            Masculino
                        </label>
                        <label class="radio-option">
                            <input type="radio" name="st_sexo" id="st_sexo" value="FEMININO" {{ ($policial->st_sexo == 'FEMININO') ? 'checked':'' }} required>
                            Feminino
                        </label>
                    </div>
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_naturalidade') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_naturalidade" type="text" class="form-control" placeholder="Ex: Natal" name="st_naturalidade" value="{{ $policial->st_naturalidade }}"> 
                ...
                <div class="form-group{{ $errors->has('st_mae') ? ' has-error' : '' }} col-md-4">
                    ...
                    <input id="st_mae" type="text" class="form-control" placeholder="Digite  o nome da mãe" name="st_mae" value="{{ $policial->st_mae }}"> 
                ...
                <div class="form-group{{ $errors->has('st_pai') ? ' has-error' : '' }} col-md-4">
                    ...
                    <input id="st_pai" type="text" class="form-control" placeholder="Digite o nome do pai" name="st_pai" value="{{ $policial->st_pai }}"> 
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_altura') ? ' has-error' : '' }} col-md-1">
                    ...
                    <input id="st_altura" type="text" class="form-control" name="st_altura" value="{{ $policial->st_altura }}" readonly> 
                ...
                <div class="form-group{{ $errors->has('st_cor') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_cutis" type="text" class="form-control" name="st_cutis" value="{{ $policial->st_cutis }}"readonly> 
                ...
                <div class="form-group{{ $errors->has('st_olhos') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_olhos" type="text" class="form-control" name="st_olhos" value="{{ $policial->st_olhos }}"readonly> 
                ...
                <div class="form-group{{ $errors->has('st_cabelo') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_cabelo" type="text" class="form-control" name="st_cabelo" value="{{ $policial->st_cabelo }}"readonly> 
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_estadocivil') ? ' has-error' : '' }} col-md-2">
                    ...
                    <div class="form-group{{ $errors->has('st_conjuge') ? ' has-error' : '' }} col-md-5" id="divConjuge">
                        ...
                        <input id="st_conjuge" type="text" class="form-control" placeholder="Digite  o nome do cônjuge" name="st_conjuge" value="{{ $policial->st_conjuge }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_cep') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_cep" type="text" class="form-control" placeholder="Ex: 00000-000" name="st_cep" value="{{ $policial->st_cep }}"> 
                ...
                <div class="form-group{{ $errors->has('st_endereco') ? ' has-error' : '' }} col-md-5">
                    ...
                    <input id="st_endereco" type="text" class="form-control" placeholder="Digite sua rua, avenida ou travessa" name="st_endereco" value="{{ $policial->st_endereco }}"> 
                ...
                <div class="form-group{{ $errors->has('st_numeroresidencia') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_numeroresidencia" type="text" class="form-control" placeholder="Ex: 12" name="st_numeroresidencia" value="{{ $policial->st_numeroresidencia }}"> 
                ...
                <div class="form-group{{ $errors->has('st_bairro') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="st_bairro" type="text" class="form-control" placeholder="Digite seu bairro" name="st_bairro" value="{{ $policial->st_bairro }}"> 
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_cidade') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="st_cidade" type="text" class="form-control" placeholder="Digite sua cidade" name="st_cidade" value="{{ $policial->st_cidade }}"> 
                ...
                <div class="form-group{{ $errors->has('st_complemento') ? ' has-error' : '' }} col-md-6">
                    ...
                    <input id="st_complemento" type="text" class="form-control" placeholder="Digite o complemento" name="st_complemento" value="{{ $policial->st_complemento }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_telefonefixo') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_telefonefixo" type="text" class="form-control" placeholder="Digite seu telefone" name="st_telefonefixo" value="{{ $policial->st_telefonefixo }}"> 
                ...
                <div class="form-group{{ $errors->has('st_telefonecelular') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_telefonecelular" type="text" class="form-control" placeholder="Digite seu celular" name="st_telefonecelular" value="{{ $policial->st_telefonecelular }}"> 
                ...
                <div class="form-group{{ $errors->has('st_email') ? ' has-error' : '' }} col-md-5">
                    ...
                    <input id="st_email" type="text" class="form-control" placeholder="Digite seu email" name="st_email" value="{{ $policial->st_email }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_codigobanco') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_codigobanco" type="text" class="form-control" placeholder="Ex: 001" name="st_codigobanco" value="{{ $policial->st_codigobanco }}"> 
                ...
                <div class="form-group{{ $errors->has('st_banco') ? ' has-error' : '' }} col-md-5">
                    ...
                    <input id="st_banco" type="text" class="form-control" placeholder="Ex: Caixa, Banco do Brasil..." name="st_banco" value="{{ $policial->st_banco }}"> 
                ...
                <div class="form-group{{ $errors->has('st_agencia') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_agencia" type="text" class="form-control" placeholder="Ex: 000" name="st_agencia" value="{{ $policial->st_agencia }}"> 
                ...
                <div class="form-group{{ $errors->has('st_conta') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_conta" type="text" class="form-control" placeholder="Ex: 000000" name="st_conta" value="{{ $policial->st_conta }}"> 
