    ...
    <hr class="separador">
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_cpf') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_cpf" type="text" disabled='true' class="form-control" name="st_cpf" placeholder="Ex: 000.000.000-00" value="{{ $policial->st_cpf }}"> 
        ...
        @can('EMITIR_RG')
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_registrocivil') ? ' has-error' : '' }} col-md-12">
                    ...
                    <input id="st_registrocivil" type="text" disabled='true' class="form-control" placeholder="Digite o número" name="st_registrocivil" value="{{ $policial->st_registrocivil }}"> 
                ...
                <div class="form-group{{ $errors->has('st_rgmilitar') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_rgmilitar" type="text" disabled='true' class="form-control" placeholder="Digite o número" name="st_rgmilitar" value="{{ $policial->st_rgmilitar }}"> 
        ...
        <div class="row">
                <div class="form-group{{ $errors->has('st_registrocivil') ? ' has-error' : '' }} col-md-12">
                    ...
                    <input id="st_registrocivil" type="text" disabled='true' class="form-control" placeholder="Digite o número" name="st_registrocivil" value="{{ $policial->st_registrocivil }}"readonly> 
                    @if ($errors->has('st_registrocivil'))
                    <span class="help-block">
                        <strong>{{ $errors->first('st_registrocivil') }}</strong>
                    </span>
                ...
                <div class="form-group{{ $errors->has('st_rgmilitar') ? ' has-error' : '' }} col-md-2">
                    <label for="st_rgmilitar">RG Militar</label>
                    <input id="st_rgmilitar" type="text" disabled='true' class="form-control" placeholder="Digite o número" name="st_rgmilitar" value="{{ $policial->st_rgmilitar }}"readonly> 
                    @if ($errors->has('st_rgmilitar'))
                    <span class="help-block">
                        <strong>{{ $errors->first('st_rgmilitar') }}</strong>
                    </span>
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_rgcivil') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_rgcivil" type="text" disabled='true' class="form-control" placeholder="Digite o número" name="st_rgcivil" value="{{ $policial->st_rgcivil }}"> 
                ...
                <div class="form-group{{ $errors->has('st_orgaorgcivil') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_orgaorgcivil" type="text" disabled='true' class="form-control" placeholder="Digite o orgão" name="st_orgaorgcivil" value="{{ $policial->st_orgaorgcivil }}"> 
                ...
                <div class="form-group{{ $errors->has('dt_emissaorgcivil') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="dt_emissaorgcivil" type="date" disabled='true' class="form-control" name="dt_emissaorgcivil" value="{{ $policial->dt_emissaorgcivil }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_titulo') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_titulo" type="text" class="form-control" disabled='true' placeholder="Digite o número" name="st_titulo" value="{{ $policial->st_titulo }}"> 
                ...
                <div class="form-group{{ $errors->has('st_zonatitulo') ? ' has-error' : '' }} col-md-1">
                    ...
                    <input id="st_zonatitulo" type="text" class="form-control" disabled='true' placeholder="Digite a zona" name="st_zonatitulo" value="{{ $policial->st_zonatitulo }}"> 
                ...
                <div class="form-group{{ $errors->has('st_secaotitulo') ? ' has-error' : '' }} col-md-1">
                    ...
                    <input id="st_secaotitulo" type="text" class="form-control" disabled='true' placeholder="Digite a seção" name="st_secaotitulo" value="{{ $policial->st_secaotitulo }}"> 
                ...
                <div class="form-group{{ $errors->has('st_municipiotitulo') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="st_municipiotitulo" type="text" class="form-control" disabled='true' placeholder="Digite o município" name="st_municipiotitulo" value="{{ $policial->st_municipiotitulo }}"> 
                ...
                <div class="form-group{{ $errors->has('st_uftitulo') ? ' has-error' : '' }} col-md-2">
                    ...
                    <select id="st_uftitulo" name="st_uftitulo" disabled='true' class="form-control">
                ...
                <div class="form-group{{ $errors->has('dt_emissaotitulo') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="dt_emissaotitulo" type="date" disabled='true' class="form-control" name="dt_emissaotitulo" value="{{ $policial->dt_emissaotitulo }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_cnh') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_cnh" type="text" class="form-control" disabled='true' placeholder="Digite o número" name="st_cnh" value="{{ $policial->st_cnh }}"> 
                ...
                <div class="form-group{{ $errors->has('st_categoriacnh') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_categoriacnh" type="text" class="form-control" disabled='true' placeholder="Digite a categoria" name="st_categoriacnh" value="{{ $policial->st_categoriacnh }}"> 
                ...
                <div class="form-group{{ $errors->has('dt_vencimentocnh') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="dt_vencimentocnh" type="date" disabled='true' class="form-control" name="dt_vencimentocnh" value="{{ $policial->dt_vencimentocnh }}"> 
                ...
                <div class="form-group{{ $errors->has('st_ufcnh') ? ' has-error' : '' }} col-md-2">
                    ...
                    <select id="st_ufcnh" name="st_ufcnh" disabled='true' class="form-control">
                        <option value="">Selecione</option>
                ...
                <div class="form-group{{ $errors->has('dt_emissaocnh') ? ' has-error' : '' }} col-md-3">
                    ...
                    <input id="dt_emissaocnh" type="date" class="form-control" disabled='true' name="dt_emissaocnh" value="{{ $policial->dt_emissaocnh }}"> 
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_carteiratrabalho') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_carteiratrabalho" type="text" class="form-control" disabled='true' placeholder="Digite o número" name="st_carteiratrabalho" value="{{ $policial->st_carteiratrabalho }}"> 
                ...
                <div class="form-group{{ $errors->has('st_seriecarteiratrabalho') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_seriecarteiratrabalho" type="text" class="form-control" disabled='true' placeholder="Digite a série" name="st_seriecarteiratrabalho" value="{{ $policial->st_seriecarteiratrabalho }}"> 
                ...
                <div class="form-group{{ $errors->has('st_ufcarteiratrabalho') ? ' has-error' : '' }} col-md-2">
                    ...
                    <select id="st_ufcarteiratrabalho" name="st_ufcarteiratrabalho" disabled='true' class="form-control">
                        <option value="">Selecione</option>
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_pispasep') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_pispasep" type="text" class="form-control" disabled='true' placeholder="Digite o número" name="st_pispasep" value="{{ $policial->st_pispasep }}"> 
        ...
        <fieldset class="scheduler-border">
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_certificadomilitar') ? ' has-error' : '' }} col-md-2">
                    ...
                    <input id="st_certificadomilitar" type="text" class="form-control" disabled='true' placeholder="Digite o número" name="st_certificadomilitar" value="{{$policial->st_certificadomilitar}}">
                ...
                <div class="form-group{{ $errors->has('st_reservista') ? ' has-error' : '' }} col-md-8">
                    <label for="st_reservista">Dados da Reservista</label>
                    <input id="st_reservista" type="text" class="form-control" disabled='true' placeholder="Dados do reservista" name="st_reservista" value="{{$policial->st_reservista}}">
