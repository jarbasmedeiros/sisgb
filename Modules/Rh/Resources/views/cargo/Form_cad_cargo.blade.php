...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            <div class="panel-heading">Cadastro Cargo</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/rh/cargos') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('st_cargo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="cargo" type="text" class="form-control" required="true" placeholder="Cargo" name="st_cargo" value="{{ old('st_cargo') }}"> 
