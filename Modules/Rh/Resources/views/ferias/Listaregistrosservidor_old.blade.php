...
@section('content_header')
    <a href="{{url('rh/registro/'.$funcionario.'/'.$tiporegsitro)}}"><h1 class="btn btn-primary">Novo Registro</h1></a>
    <a href="{{url('/rh/listacrportipo/'.$funcionario.'/'.$tiporegsitro.'/impressao')}}"><h1 class="btn btn-primary">Imprimir</h1></a>
@stop
@endcan
                        ...
                        @if(isset($registros) && count($registros)>0)
                                <thead>
                                    <tr class="bg-primary">
                                        <th colspan="7">
                                        @if(isset($registros))
                                        Lista de {{$registros[0]->st_tiporegistro}}
                                        @endif
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                @foreach($registros as $r)
                                        ...
                                        <tr>
                                            ...
                                            @foreach($caderneta  as  $valor)
                                                ...
                                                <th>{{date('d/m/Y',strtotime($valor->st_valor))}}<br/>
