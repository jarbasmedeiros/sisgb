            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('rh/historicoferias/update/' . $idPolicial . '/' . $idFerias . '/' . $historico->id) }}">
                            {{ csrf_field() }}
                            @if($historico->st_tipo == 'Ferias')
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-2">
                                    <a href="{{url('rh/historicoferias/lista/' . $idPolicial . '/' . $idFerias)}}" class=" btn btn-danger" title="Voltar">
