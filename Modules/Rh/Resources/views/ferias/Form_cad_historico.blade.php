            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('rh/historicoferias/store/ferias/' . $idPolicial . '/' . $idFerias) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-2">
                                    <a href="{{url('rh/historicoferias/lista/' . $idPolicial . '/' . $idFerias)}}" class=" btn btn-warning" title="Voltar">
