...
@section('title', 'Lista de Atendimentos Diários da CMAPM')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="scheduler-border">
                        <table class="table table-bordered">
                            <thead>
                                <tr class="bg-primary">
                                    <th colspan = "9">Lista de Policiais Militares atendidos pela CMAPM em {{date('d/m/Y')}} </th>                            
                                    <th>
                                        <div class="col-md-1">
                                            <a href="{{url('/juntamedica/atendimentos/pdf')}}" class="btn btn-primary"  target="_blank" title="Imprimir PDF">
