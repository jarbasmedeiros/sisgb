...
<head>
    ...
    <title>Lista de Atendimentos Diários da CMAPM</title>
</head>
    ...
    <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered">
                    <thead>
                        <tr class="bg-primary">
                            <th colspan = "8">Lista de Policiais Militares atendidos pela CMAPM em {{date('d/m/Y')}} </th>                             
                        </tr>
                        <tr>
                            ...
                            <th class="col-md-3">Restrição</th>
