    ...
    <div class="row"> 
                ...
                <form id="form" class="form-contact" role="form" method="POST" 
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-row">
                            ...
                            <p style="color:red; font-weight: bold;">Selecione uma das fichas disponíveis de escrituração</p>
                            @endif
                            <input name="ce_ficha"  type="hidden" value="{{Request::segment(9)}}">
                                ...
                                @switch($pontuacao->nu_item)
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        ...
                                                        <select disabled name="COMPORTAMENTO[st_criterio]" class="form-control select2-container camposObrigatorios {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                    ...
                                    @case(5) <!-- Doacao de sangue -->
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="form-inline">
                                                        <select disabled id="sangue" name="{{$pontuacao->st_nomeinterno}}[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                            <option value="" selected>Selecione...</option>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="form-inline">
                                                        Resultado: 
                                                        <select disabled id="taf" name="{{$pontuacao->st_nomeinterno}}[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                    ...
                                                    @if (!$achouArquivo)
                                                        <th id="ARQUIVO{{$pontuacao->nu_item}}">
                                                            <input disabled onchange="inserirDescricao('ARQUIVO{{$pontuacao->nu_item}}', 'doc07')" type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}[st_path]" accept="application/pdf">
                                                        </th>  
                                                    @endif 
                                    ...
                                    @case(8) <!-- Curso Superior -->
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        <select disabled id="formacao" name="FORMACAO[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                            <option selected="selected" value="">Selecione...</option>
                                                    ...
                                                    @if (!$achouArquivo)
                                                        <th id="ARQUIVO{{$pontuacao->nu_item}}">
                                                            <input disabled onchange="inserirDescricao('ARQUIVO{{$pontuacao->nu_item}}', 'doc08')" type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}[st_path]" accept="application/pdf">
                                                        </th>  
                                                    @endif 
                                    ...
                                    @case(9) <!-- Cursos com Aplicabilidade à Caserna -->
                                            ...
                                            <tr id="curso_{{$pontuacao->id}}">
                                                @if($contCurso > 1)
                                                    <th>
                                                        <select disabled  id="curso{{$contCurso}}" name="CURSO{{$contCurso}}[st_label]" class="form-control select2-container selectAdcional {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                            <option selected="selected" value="">Selecione...</option>
                                                ...
                                                @endif
                                                <th>
                                                    <input disabled name="CURSO{{$contCurso}}[st_criterio]" class="form-control {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}} curso" type="text" value="{{$pontuacao->st_criterio}}">
                                                </th>
                                                <th>
                                                    <input disabled name="CURSO{{$contCurso}}[st_publicacao]" class="form-control {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}} curso" type="text" value="{{$pontuacao->st_publicacao}}">
                                                </th>
                                                @if($pontuacao->nu_ordem != 1)
                                                        <th class="col-md-1">
                                    ...
                                    @case(10) <!-- Contribuição Científica -->
                                        ...
                                        @endif   
                                                ...
                                                @if ( isset($pontuacao->st_nomeinterno) && 
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <select disabled id="cientifico" name="CIENTIFICO1[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                                <option selected="selected" value="">Selecione...</option>
                                                        ...
                                                        @if (!$achouArquivo)
                                                            <th id="ARQUIVO{{$pontuacao->nu_item}}_1">
                                                                <input  type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}_1[st_path]" accept="application/pdf">
                                                            </th>  
                                                        @endif 
                                                ...
                                                && 
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <select disabled id="cientifico" name="CIENTIFICO2[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                                <option selected="selected" value="">Selecione...</option>
                                                        ...
                                                        @if (!$achouArquivo)
                                                            <th id="ARQUIVO{{$pontuacao->nu_item}}_2">
                                                                <input  type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}_2[st_path]" accept="application/pdf">
                                                            </th>  
                                                        @endif 
                                                ...
                                                <tr>
                                                    <th>
                                                        <select disabled id="cientifico" name="CIENTIFICO3[st_criterio]" class="form-control select2-container {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                            <option selected="selected" value="">Selecione...</option>
                                                    ...
                                                    @if (!$achouArquivo)
                                                        <th id="ARQUIVO{{$pontuacao->nu_item}}_3">
                                                            <input  type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}_3[st_path]" accept="application/pdf">
                                                        </th>  
                                                    @endif 
                                    ...
                                    @case(11) <!-- Punições -->
                                            ...
                                            <tr id="punicao_{{$pontuacao->id}}">
                                                @if($contPunicao > 1)
                                                    <th>
                                                        <select disabled  id="punicao{{$contPunicao}}" name="PUNICAO{{$contPunicao}}[st_criterio]" class="form-control select2-container camposObrigatorios {{$pontuacao->bo_pontoaceito === '0'?'intensAlteracao':''}}">
                                                            <option selected="selected" value="">Selecione...</option>
                                                ...
                                                @php $achouArquivo = false; @endphp
                                                    ...
                                                    @if (!$achouArquivo)
                                                        <th id="ARQUIVO{{$pontuacao->nu_item}}_{{$contPunicao}}">
                                                            <input  type="file" class="form-control-file" name="ARQUIVO{{$pontuacao->nu_item}}_{{$contPunicao}}[st_path]" accept="application/pdf">
        ...
        <!--             <a href="{{url('promocao/fichasgtnaoenviada/'.$idQuadro.'/'.$idAtividade.'/competencia/'.$competencia)}}" title="Voltar" class="btn btn-warning">
                    ...
                    @if( Request::segment(3) == 'visualizarhomologadas'  ) 
                        ...
                        <a href="{{url('promocao/fichas/visualizarhomologadas/'.$idQuadro.'/'.$idAtividade.'/'.$idPolicial.'/competencia/'.$competencia)}}" title="Voltar" class="btn btn-warning">
                            <span class="glyphicon glyphicon-arrow-left"></span> Voltar para ficha
                        </a> 
                    @endif
                        ...
                        <!-- TODO - desabilitar botões da tela de consulta  -->
