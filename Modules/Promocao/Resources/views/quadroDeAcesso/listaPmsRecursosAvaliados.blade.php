    ...
    <div class="row">
        <div class="panel panel-primary container-fluid">
            <div class="panel-heading row">
                <div class="col-md-10">
                    <h4>Fichas de reconhecimento enviadas</h4>
                </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-row form-inline">
                        <form method="post" action="{{url('promocao/listarecursosavaliados/buscasgt/'.$quadro->id.'/'.$atividade->id.'/1' . '/competencia/'.$competencia)}}">
                            {{csrf_field()}}
