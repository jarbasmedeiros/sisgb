...
@endphp
@section('title', 'SISGP - Inspeção de Saúde')
@section('content')
<div class="container-fluid">
        ...
        <div class="panel panel-primary container-fluid">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-row">
                        <form method="POST" role="form" action="{{url('promocao/resultadoinspecaodesaude/'.$quadro->id.'/'.$atividade->id)}}">
                            {{csrf_field()}}
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                @if(!isset($c->st_assinatura) && $c->st_matriculaassinante == $matriculaLogada)
                                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-placement="top" data-target="#assinarComissaoConfirmacaoModal" title="Assinar"><i class="fa fa-key"></i></button> | 
                                                @endif
                                ...
                                @foreach($policiaisQuadro as $policial)
                                    ...
                                    <tr>
                                        ...
                                        @if($policial->bo_pendenciapreanalisejpms == 1)
                                            <th>Pendente</th>
                                        @else
                                            <th>{{$policial->st_inspecaojuntaparecer}}{{' '.$policial->st_inspecaojuntaobs}}</th>
                                        @endif
                                        <th></th>
                                    </tr>
                                @endforeach
    ...
    <div class="form-group">
        ...
        <form action="{{url('/promocao/resultadodaInpecaodesaude/'.$idQuadro.'/'.$atividade->id.'/gerarNota/visualizar')}}" method="POST">
        {{csrf_field()}}
    ...
    <div class="modal fade" id="assinarModal" tabindex="-1" role="dialog" aria-labelledby="assinarModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="{{url('/promocao/resultadodaInpecaodesaude/'.$idQuadro.'/'.$atividade->id.'/gerarNota/finalizar')}}" method="POST">
                {{csrf_field()}}
    ...
    <!-- @aggeu. Issue 219. -->
    <!-- Moldal para botão assinar da comissão - assinatura -->
    ...
    <!-- @aggeu. Issue 219. -->
    <!-- Modal para adicionar policial na comissão - buscar policial -->
    ...
    <!-- @aggeu. Issue 219. -->
    <!-- Modal para adicionar policial na comissão - adicionar -->
