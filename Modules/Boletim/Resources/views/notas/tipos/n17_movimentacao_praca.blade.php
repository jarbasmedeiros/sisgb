            ...
            <div class="panel-body">
                <div class="row">
                    <div class="form-group">
                        <label for="ce_tipo" class="col-md-3 control-label">Unidade de destino <Strong><span style="color: red">*</span></strong></label>
                        <div class="col-md-3">                                
                ...
                <div class="row">
                    <div class="form-group">
                        <label for="dt_acontar" class="col-md-3 control-label">Data a contar <Strong><span style="color: red">*</span></strong></label>
                        <div class="col-md-3">                                   
                ...
                <div class="row">
                    <div class="form-group" >
                        ...
                        <div class="col-md-3">                                
                            ...
                            <select class="form-control select2" style="width: 100%" id="ce_novafuncao"  required name="ce_novafuncao">
                                <option value="">Selecione</option>
...
function removerPmQualquerNota(){
    ...
    if( idPolicial==''){
        ...
        var baseUrl = getBaseUrl()+"/boletim/tiponota/delpolicialparacadatiponota";//web rota de service e nao de api
