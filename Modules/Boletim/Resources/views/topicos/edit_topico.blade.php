    ...
    <div class="container">
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading">Editar Tópico</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="{{url('/boletim/topico/update/'.$topico->id)}}">
                    {{csrf_field()}}
                        <div class="form-group">
                            <label for="st_parte" class="col-md-4 control-label">Parte do boletim</label>
                            <div class="col-md-3">
                           
                                <select id="st_parte"  required name="st_parte" class="form-control" required>

                                    <option value="{{$topico->st_parte}}">{{$topico->st_parte}}ª parte</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="st_topico" type="input" required class="form-control" name="st_topico" value="{{$topico->st_topico}}"> 
