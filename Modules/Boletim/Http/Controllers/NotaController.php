...
use Modules\Api\Services\TipoNotaService;
...
class NotaController extends Controller
{
     ...
     * @return Response
     */
    public function __construct(BoletimService $BoletimService, PolicialService $PolicialService, NotaService $NotaService, ArquivoBancoService $ArquivoBancoService, DjdService $DjdService){
           ...
           //busca a blade específica do tipo de nota
                    switch ($tipoNota->id) {
                        ...
                        case 23:
                            ...
                            break;
                        case 24:
                            $tipoNotaService = new TipoNotaService();
                            $policiaisDaNota = $tipoNotaService->listarPolicialParaCadaTipoNotas($dadosDaNota);
                            $funcaoService = new FuncaoService();
                            $funcoes = $funcaoService->getFuncoes();
                            return view('boletim::notas/tipos/'.$tipoNota->st_nometela,compact('tipos', 'nota', 'tipoNota', 'policiaisDaNota','unidades','funcoes')); 
                            break;
    ...
    public function update(Request $request, $id){
        try{
          ...
          //  dd($nota);
            ...
            $dadosform['id']= $id;
            $dadosform['ce_nota']= $id;
          /*   if(in_array($dadosform['ce_tipo'],[24])){
                //dd('é tipo 24---');
    ...
    */  
    ...
    /**
     * @author juanmojica - #468
     * @param Int (id do procedimento)
     * @return Object  (objeto procedimento ou mensagem de erro)
     */
    public function consultarProcedimento($numSEI) {
        try {
            $dadosForm['st_criterio'] = 'st_numsei';
            $dadosForm['st_filtro'] = $numSEI;

            $procedimento = $this->DjdService->buscarProcedimentos($dadosForm);
