...
namespace Modules\Boletim\Http\Controllers\Tiposnotas\Notas;
...
class N24InstauracaoProcedimentoController extends Controller
{
    /**
    ...
    public function __construct(    ){
      ...
      //  $this->PolicialService = new PolicialService;
      //  $this->NotaService = new NotaService;
      //  $this->ArquivoBancoService = new ArquivoBancoService;
    }
...
//dd($dadosForm);
          ...
          //  $dadosform = $request->all();
           if(isset($dadosForm['ce_tipo'])){
            ...
            $nota =  $notaService->getNotaId($dadosForm['id']);
           // dd($nota);
            ...
            $resultado =  $tipoNotaService->atualizarNotaParaCadaTipoNota($dadosForm);
            //return redirect('/boletim/nota/edit/'.$nota->id."/".$dadosForm['ce_tipo'])->with('sucessoMsg', MSG::NOTA_ALTERADA_COM_SUCESSO);
            return redirect('/boletim/nota/edit/'.$nota->id."/".$dadosForm['ce_tipo'])->with('sucessoMsg', $resultado->msg);
